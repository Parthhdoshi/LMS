    ...
    <div className="w-[90%] 800px:w-[85%] m-auto">
      <div className="w-full 800px:flex items-center">
        ...
        <div className="800px:w-[50%] w-full">
          ...
          LMS Academy empowers aspiring civil engineers with cutting-edge knowledge and real-world expertise. Our courses are designed to bridge the gap between theory and practice, helping students build a strong foundation for a successful career in civil engineering
          </p>
        </div>
        <br />
        <br />
