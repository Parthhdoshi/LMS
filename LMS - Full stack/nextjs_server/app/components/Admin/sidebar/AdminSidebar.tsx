        ...
        <Menu>
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            <Typography
              ...
              sx={{ m: "15px 0 5px 20px" }}
            >
              {!isCollapsed && "Certificate"}
            </Typography>
            <Item
              title="Certificate"
              to="/admin/certificate"
              icon={
                <WorkspacePremiumIcon className="text-black dark:text-white" />
              }
              selected={selected}
              setSelected={setSelected}
            />
            ...
            <Item
              ...
              to="/admin/quiz"
              icon={
                <TaskAltIcon className="text-black dark:text-white" />
              }
              selected={selected}
              setSelected={setSelected}
            />
            ...
            <Item
              ...
              to="/admin/task"
              icon={
                <QuestionAnswerIcon className="text-black dark:text-white" />
              }
              selected={selected}
              setSelected={setSelected}
            />
